...
|---|---|---|
| `daily` | `{}` | 每天 |
| `weekly` | `{"weekday":1-7}` ISO，1=周一，7=周日 | 今天星期几等于 `weekday` |
| `monthly` | `{"day":1-31}` | 今天几号等于 `day`；本月没有这一天则不命中 |
| `quarterly` | `{"month_of_quarter":1-3,"day":1-31}` | 本季第几月且几号匹配；没有这一天则不命中。Q1=1-3月，Q2=4-6，Q3=7-9，Q4=10-12 |
| `yearly` | `{"month":1-12,"day":1-31}` | 月日匹配；没有这一天则不命中 |

JSON 缺字段或看不懂：跳过并说明，不要猜。

下一次命中 = 今天之后（不含今天）最近一个命中日。`daily` 就是明天。
